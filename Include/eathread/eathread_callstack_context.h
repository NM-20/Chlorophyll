	...
	namespace Thread
	{
		...
		struct ContextARM64
		{
			...
			union
			{
				...
				uint16_t mUFB_INT16Array[512/sizeof(uint16_t)];    // Access Neon registers as uint16_t's
				uint32_t mUFB_INT32Array[512/sizeof(uint32_t)];    // Access Neon registers as uint32_t's
