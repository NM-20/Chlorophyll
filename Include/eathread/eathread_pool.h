...
namespace EA
{
	namespace Thread
	{
		...
		protected:
			...
			AtomicFB_INT32         mnCurrentCount;             // Current number of threads available.
			AtomicFB_INT32         mnActiveCount;              // Current number of threads busy with jobs.
			...
			AtomicFB_INT32         mnPauseCount;               // A positive value means we pause working on jobs.
			AtomicFB_INT32         mnLastJobID;                // 
