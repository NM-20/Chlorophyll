...
namespace EA
{
	...
	namespace EA
	{
		namespace Thread
		{
			...
			/// will find that AtomicFB_INT32 is essentially a platform independent interface to 
			/// the Win32 InterlockedXXX family of functions. Those familiar with Linux may 
			/// find that AtomicFB_INT32 is essentially a platform independent interface to atomic_t 
			/// functionality.
			///
...
namespace EA
{
	namespace Thread
	{
		...
		// Typedefs
		typedef AtomicInt<int32_t>  AtomicFB_INT32;   /// int32_t  atomic integer.
		typedef AtomicInt<uint32_t> AtomicFB_UINT32;  /// uint32_t atomic integer.
		...
		typedef AtomicInt<uint64_t> AtomicUint64;  /// uint64_t atomic integer.
			...
			typedef AtomicFB_INT32  AtomicIWord;
			typedef AtomicFB_UINT32 AtomicUWord;
		#else
			...
			typedef AtomicFB_INT32  AtomicIntPtr;
			typedef AtomicFB_UINT32 AtomicUintPtr;
		#else
		...
		/// to AtomicFB_INT32. This is reasonably safe because AtomicFB_INT32 uses intptr_t
