...
/// 
	...
	struct EATHREADLIB_API EABarrierData{
		EA::Thread::AtomicFB_INT32    mnCurrent;       // Current number of threads. As threads wait, this value decreases towards zero.
		int                        mnHeight;        // Number of threads required.
		EA::Thread::AtomicFB_INT32    mnIndex;         // Which semaphore we are using.
