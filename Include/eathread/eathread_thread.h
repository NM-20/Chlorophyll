...
EA_RESTORE_ALL_VC_WARNINGS()
	...
	// Suppress warning about class 'AtomicFB_INT32' needs to have a
...
/////////////////////////////////////////////////////////////////////////
	...
	struct EAThreadDynamicData
	{
		...
		EA::Thread::AtomicFB_INT32 mnRefCount;
		EA::Thread::AtomicFB_INT32 mStatus;
...
// TODO:  collapse the defines.
	...
	struct EAThreadTimerQueue
	{
		...
		EA::Thread::AtomicFB_UINT32 mCurrentId = 0;
...
namespace EA
{
	namespace Thread
	{
		...
		/// ThreadParameters
		/// Used for specifying thread starting parameters.
		...
		protected:
			...
			static EA::Thread::AtomicFB_INT32     sDefaultProcessor;
