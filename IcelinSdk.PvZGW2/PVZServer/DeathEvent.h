...
/* TypeInfo (Array): 00000001428604E8
   RuntimeId:        1E5A
   TypeInfo Kind:    DataContainerClassInfo
   ClassId:          05F9
   VfTable:          0000000142320480
   Address (Base):   0000000143109E70
*/
#pragma pack(push, 16)
...
public:
  ...
  Vec3 KillerPosition; /* 0x0030 */
  FB_UINT64 KillerId; /* 0x0040 */
...
static_assert(sizeof(DeathEvent) == 96);
