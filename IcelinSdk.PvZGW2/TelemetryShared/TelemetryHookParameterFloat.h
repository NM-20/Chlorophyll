...
/* TypeInfo (Array): 0000000142874C10
   RuntimeId:        2C8D
   TypeInfo Kind:    ValueTypeInfo
   VfTable:          0000000000000000
   Address:          00000001430C0968
   Default Value:    0000000142874C28
*/
#pragma pack(push, 8)
...
static_assert(sizeof(TelemetryHookParameterFloat) == 24);
