...
/* TypeInfo (Array): 0000000142836EC0
   RuntimeId:        0466
   TypeInfo Kind:    DataContainerClassInfo
   ClassId:          1270
   VfTable:          00000001421FA4A0
   Address (Base):   0000000143118210
*/
#pragma pack(push, 8)
...
public:
  ...
  AudioGraphNodePort Order; /* 0x0020 */
...
static_assert(sizeof(HighPassButterworthNodeData) == 56);
