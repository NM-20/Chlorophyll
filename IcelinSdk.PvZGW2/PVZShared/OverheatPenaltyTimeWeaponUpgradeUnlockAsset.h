...
/* TypeInfo (Array): 0000000142869228
   RuntimeId:        246F
   TypeInfo Kind:    DataContainerClassInfo
   ClassId:          0744
   VfTable:          0000000142355F08
   Address (Base):   00000001430DA130
*/
#pragma pack(push, 8)
...
static_assert(sizeof(OverheatPenaltyTimeWeaponUpgradeUnlockAsset) == 88);
